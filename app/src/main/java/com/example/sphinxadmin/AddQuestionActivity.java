...
public class AddQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.question_add_question);
        options = findViewById(R.id.options_add_question);
        answers = findViewById(R.id.answers_add_question);
        uploadBtn = findViewById(R.id.button_add_question);
